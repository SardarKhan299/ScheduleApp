...
import static com.schedulix.Fragments.BlockDateForm.appointmentArrayList;

/**
 * A simple {@link Fragment} subclass.
 * Activities that contain this fragment must implement the
 * {@link SelectMultipleDate.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SelectMultipleDate#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SelectMultipleDate extends Fragment {
     ...
     * @return A new instance of fragment SelectMultipleDate.
     */
    // TODO: Rename and change types and number of parameters
    public static SelectMultipleDate newInstance(String param1, String param2) {
        SelectMultipleDate fragment = new SelectMultipleDate();
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_select_multiple_date, container, false);
        ...
        mvc.setOnDateChangedListener(new OnDateSelectedListener() {
            ...
            public void onDateSelected(@NonNull MaterialCalendarView widget, @NonNull CalendarDay date, boolean selected) {
                ...
                appointmentArrayList.add(allblockdates);
                appointmentAdapter = new Adpater_blockdates(context,appointmentArrayList,"0");
                // Attach the adapter to the recyclerview to populate items
                rvSelectedDates.setAdapter(appointmentAdapter);
               // appointmentAdapter.notifyDataSetChanged();
