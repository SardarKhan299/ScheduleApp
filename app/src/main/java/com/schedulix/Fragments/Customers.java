...
public class Customers extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle("Cutomer");
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(AddCustomer.newInstance("",""), "Create Customer");
        adapter.addFragment(ListOfStaff.newInstance(userId,""), "List of Customer");
