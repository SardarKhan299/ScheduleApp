...
public class FeedBack extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        report_issue = (Button) view.findViewById(R.id.btn_report);
    ...
    private void sendEmail() {
        ...
        report_issue.setEnabled(false);

        Intent i = new Intent(Intent.ACTION_SEND);
        i.setType("message/rfc822");
        i.putExtra(Intent.EXTRA_EMAIL  , new String[]{"contact@schedulix.com"});
        i.putExtra(Intent.EXTRA_SUBJECT, "Schedulix Android Feedback");
        i.putExtra(Intent.EXTRA_TEXT   , "Hello ");
        try {
            startActivity(Intent.createChooser(i, "Send mail..."));
            progressBar.setVisibility(View.GONE);
            report_issue.setEnabled(true);
