...
public class Services extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle("Service");
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(AddService.newInstance("",""), "Create Service");
        adapter.addFragment(ListOfServices.newInstance(userId,""), "List Of Services");
...
//        }
    ...
    public static void MoveNextFragment() {
